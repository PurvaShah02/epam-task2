...
class InterestTest {
	...
	void simple_interest_test() {
		assertEquals("Error at Simple Interestt",137.99999999999997,i.simple_interest(1500,2,4.6),0.0);
		assertEquals("Error at Simple Interestt",7.2,i.simple_interest(15,12,4),0.0);
		assertEquals("Error at Simple Interestt",1368.0,i.simple_interest(12000,3.8,3),0.0);
	}
	@Test
